...
<h1><a href="index.php"><i class="fas fa-tachometer-alt"></i>  Dashboard</a> <small>Covid 19 Satistics Overview</small></h1>
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="float-sm-right">Total Covid Patients</div>
          </div>
        </div>
      </div>
