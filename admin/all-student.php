...
?>
<h1 class="text-primary"><i class="fas fa-users"></i>  All Patients<small class="text-warning"> All Patients List!</small></h1>
...
<table class="table  table-striped table-hover table-bordered" id="data">
  ...
  <tbody>
    <?php 
      $query=mysqli_query($db_con,'SELECT * FROM `patients` ORDER BY `patients`.`datetime` DESC;');
      $i=1;
